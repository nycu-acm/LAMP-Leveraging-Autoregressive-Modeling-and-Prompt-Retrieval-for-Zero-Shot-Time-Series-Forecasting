...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        trend_stamp, seasonal_stamp, resid_stamp = self.stl_resolve(data_raw, data_name=data_name)
...
class Dataset_ETT_minute(Dataset):
    ...
    def __read_data__(self):
        ...
        df_time = df_raw[col_date]
        data_raw = pd.DataFrame.join(df_time, pd.DataFrame(data))
        trend_stamp, seasonal_stamp, resid_stamp = self.stl_resolve(data_raw, data_name=self.data_path.split('.')[0])
...
class Dataset_Custom(Dataset):
    ...
    def stl_resolve(self, data_raw, data_name):
        ...
        save_stl = stl_position +  data_name   
        # save_stl = 'stl/' + 'weather'   
