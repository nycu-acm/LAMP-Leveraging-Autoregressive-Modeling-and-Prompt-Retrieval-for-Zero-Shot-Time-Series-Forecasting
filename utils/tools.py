...
def visual(args,true, preds=None, name='./pic/test.pdf'):
    """
    ...
    plt.plot(range(args.seq_len), true[:args.seq_len], label='History', color='blue')

    # Plot true future values
    plt.plot(range(args.seq_len, args.seq_len + args.token_len), true[args.seq_len:], label='True Future', color='green')

    if preds is not None:
        # plt.plot(preds, label='Prediction', linewidth=2)
        plt.plot(range(args.seq_len, args.seq_len + args.token_len), preds[args.seq_len:], label='Predicted Future', color='red', linestyle='dashed')
