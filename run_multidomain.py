...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--datasets', type=str, default='electricity,traffic,weather')
    ...
    parser.add_argument('--target_data', type=str, default="ETTh1", help='target data for zero shot')
    ...
    parser.add_argument('--llm_ckp_dir', type=str, default='./Llama-2-7b-hf', help='llm checkpoints dir')
    ...
    #eval_data
    parser.add_argument('--eval_data', type=str, default='ETTm1')
